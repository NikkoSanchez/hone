...
7. Save the result as a `.html` file in the requested location. If no location is requested, save artifacts in `~/.hone/html-artifacts` with an obvious, hyphen-case filename, creating the directory when needed.
